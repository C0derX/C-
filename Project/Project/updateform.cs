...
namespace Project
{
    public partial class updateform : UserControl
    {
        ...
        {
            sql.Open();
            SqlCommand cmd = new SqlCommand("select Roomno from checkout order by Roomno asc", sql);
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from checkout where Roomno='" + loadroom.Text + "'", sql);
            sql.Open();
            cmd.ExecuteNonQuery();
            SqlDataReader dr = cmd.ExecuteReader();
            while (dr.Read())
        ...
        private void updatebtn_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("Update checkout set Firstname='" + txtfirstname.Text + "', Lastname='" + txtlastname.Text + "',Roomno='" + txtroomno.Text + "',Roomtype='" + txtroomtype.Text + "',Checkindate='" + txtcheckintime.Text + "',Checkoutdate='" + txtcheckouttime.Text + "',People='" + txtpeopleno.Text + "',Gender='" + txtgender.Text + "',Address='" + txtaddress.Text + "',Country='" + txtcountry.Text + "' where Roomno='" + loadroom.Text + "'", sql);
                cmd.ExecuteNonQuery();
                loadroom.Items.Clear();
                clear();
        ...
        private void deletebtn_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("Delete from checkout where Roomno='" + loadroom.Text + "'", sql);
                cmd.ExecuteNonQuery();
                loadroom.Items.Clear();
                clear();
            }
